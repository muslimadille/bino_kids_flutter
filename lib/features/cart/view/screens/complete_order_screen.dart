  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvoked: (value)  async{
        context.read<CartProvider>().promoCodeId="";
        context.read<CartProvider>().promoDiscount=0.0;
        context.read<CartProvider>().shippingPrice=0.0;
        context.read<CartProvider>().totalPriceAfterDiscount=0.0;
